...
export default function Home () {
    return (
        <div className={"d-flex flex-column h-100 w-100 justify-content-center align-items-center gap-2"}>
            ...
            <h1 className={"m-0"}>BikeFla<MdFlashOn style={{height: "3rem", margin: "0 -0.5rem"}} className={"text-primary"}/>h</h1>
            <Link to={"/register"} className="btn btn-primary btn-lg primary" >
