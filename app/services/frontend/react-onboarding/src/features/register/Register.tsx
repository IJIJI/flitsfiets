...
export default function Register() {
    ...
    const [onboardingData, setOnboardingData] = useState<OnboardingData>({
        ...
        address: {city: "", country: "", numberAddition: "", postalCode: "", street: "", streetNumber: 0},
    ...
    return (
        ...
        >
            ...
            <FormStep>
                <BikeCardGrid>
                    <BikeCard index={1} activeIndex={onboardingData.bikeType} setIndex={setActiveBike} title={"Regular"}
                    ...
                    <BikeCard index={3} activeIndex={onboardingData.bikeType} setIndex={setActiveBike}
                              ...
                              icon={<MdElectricBike/>}/>
                    <BikeCard index={4} activeIndex={onboardingData.bikeType} setIndex={setActiveBike} title={"Moped"}
            ...
            <FormStep>
                <Form innerRef={detailsFormRef} onInput={updateDetailsFormValidity}
                    ...
                    <Col className={"d-flex flex-row gap-2 p-0 m-0"}>
                        ...
                        <FormGroup className={"col-6"}>
                            <Label className={"m-0"} for="streetnumber">House Number (No Addition):</Label>
                    ...
                    <FormGroup>
                        ...
                        <Input type="text" name="country" id="country" value={"Netherlands"} disabled/>
                    </FormGroup>
